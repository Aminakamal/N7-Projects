...
let%test "enum_simple_c1" =
  test (pathFichiersRat^"testEnumPlacementSimple.rat") "main" ("c1",1) (0, "SB")
|| test (pathFichiersRat^"testEnumPlacementSimple.rat") "main" ("c1",1) (0, "LB")

let%test "enum_simple_c2" =
  test (pathFichiersRat^"testEnumPlacementSimple.rat") "main" ("c2",1) (1, "SB")
|| test (pathFichiersRat^"testEnumPlacementSimple.rat") "main" ("c2",1) (1, "LB")

let%test "enum_simple_x" =
  test (pathFichiersRat^"testEnumPlacementSimple.rat") "main" ("x",1) (2, "SB")
|| test (pathFichiersRat^"testEnumPlacementSimple.rat") "main" ("x",1) (2, "LB")

(* Test enum dans une fonction *)
let%test "enum_fonction_j" =
  test (pathFichiersRat^"testEnumPlacementFonction.rat") "main" ("j",1) (0, "SB")
|| test (pathFichiersRat^"testEnumPlacementFonction.rat") "main" ("j",1) (0, "LB")

let%test "enum_fonction_param_x" =
  test (pathFichiersRat^"testEnumPlacementFonction.rat") "getJour" ("x",1) (-1, "LB")

(* Test enum avec passage par référence *)
let%test "enum_ref_a" =
  test (pathFichiersRat^"testEnumPlacementRef.rat") "main" ("a",1) (0, "SB")
|| test (pathFichiersRat^"testEnumPlacementRef.rat") "main" ("a",1) (0, "LB")

let%test "enum_ref_b" =
  test (pathFichiersRat^"testEnumPlacementRef.rat") "main" ("b",1) (1, "SB")
|| test (pathFichiersRat^"testEnumPlacementRef.rat") "main" ("b",1) (1, "LB")

let%test "enum_ref_tmp" =
  test (pathFichiersRat^"testEnumPlacementRef.rat") "swap" ("tmp",1) (3, "LB")

let%test "enum_ref_param_c1" =
  test (pathFichiersRat^"testEnumPlacementRef.rat") "swap" ("c1",1) (-2, "LB")

let%test "enum_ref_param_c2" =
  test (pathFichiersRat^"testEnumPlacementRef.rat") "swap" ("c2",1) (-1, "LB")
