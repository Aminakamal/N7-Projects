...
% Ajout d'un effet :
% y_modifie = changement_vitesse(y, f_ech, 0.8);	% Paramètre à faire varier entre 0.8 et 1.5
 y_modifie = etirement_temporel(y, 0.8);		% Paramètre à faire varier entre 0.8 et 1.4
