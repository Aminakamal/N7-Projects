...
(* Les tests des affectabls *)
let%expect_test "testAffectableExecution" =
  runtam (pathFichiersRat^"testAffectableExecution.rat");
  [%expect{| 232 |}]

let%expect_test "testAffectableExpression" =
  runtam (pathFichiersRat^"testAffectableExpression.rat");
  [%expect{| 15 |}]
  
(* Les tests des pointeurs *)
let%expect_test "testPointeurBasique" =
  runtam (pathFichiersRat^"testPointeurBasique.rat");
  [%expect{| 5 |}]

let%expect_test "testPointeurAffectation" =
  runtam (pathFichiersRat^"testPointeurAffectation.rat");
  [%expect{| 20 |}]

let%expect_test "testPointeurNew" =
  runtam (pathFichiersRat^"testPointeurNew.rat");
  [%expect{| 42 |}]

let%expect_test "testPointeurChaine" =
  runtam (pathFichiersRat^"testPointeurChaine.rat");
  [%expect{| 22 |}]
